...
public class Complex {
    ...
    public Complex add(Complex other) {
        return new Complex(real + other.getReal(), imaginary + other.getImaginaer());
    }
    ...
    public Complex mul(Complex other) {
        return new Complex((real * other.getReal() - imaginary * other.getImaginaer()), (real * other.getImaginaer() + other.getReal() * imaginary));
    }
